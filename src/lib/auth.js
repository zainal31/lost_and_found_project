...
const DEFAULT_ADMIN_HASH = "240be518fabd2724ddb6f04eeb1da5967448d7e831c08c8fa822809f74c720a9"; // sha256 of 'admin123'
...
export async function loginAdmin({ username, password }) {
	...
	if (username !== ADMIN_CREDENTIALS.username || inputHash !== storedAdminHash) {
		return null;
	}
	const user = {
		role: "admin",
