					...
					<form className="space-y-6" onSubmit={handleSubmit} noValidate>
						...
						<div>
							...
							<div className="relative group border-2 border-dashed border-gray-300 rounded-2xl p-6 flex flex-col items-center justify-center bg-gray-50/50 hover:bg-gray-50 hover:border-kampus-blue transition-all cursor-pointer">
								<input id="foto" name="foto" type="file" accept="image/*" onChange={handleImageChange} required className="absolute inset-0 w-full h-full opacity-0 cursor-pointer z-10" />
						...
						<div className="pt-4 flex gap-4">
							<button type="submit" disabled={loading} className="flex-1 bg-kampus-gold text-white font-bold py-3 px-4 rounded-lg hover:bg-yellow-600 transition-colors shadow-md disabled:opacity-60">
